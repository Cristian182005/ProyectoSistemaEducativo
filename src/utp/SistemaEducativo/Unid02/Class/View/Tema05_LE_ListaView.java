...
import utp.SistemaEducativo.Unid02.Class.Tema05p2_LE_Lista;
...
public class Tema05_LE_ListaView extends javax.swing.JFrame {
    
    private Tema05p2_LE_Lista lista = new Tema05p2_LE_Lista();
    
    public Tema05_LE_ListaView() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tema05_LE_ListaView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tema05_LE_ListaView().setVisible(true);
            }
        });
    }
