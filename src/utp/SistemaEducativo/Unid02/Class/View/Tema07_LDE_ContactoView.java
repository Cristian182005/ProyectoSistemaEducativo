...
import utp.SistemaEducativo.Unid02.Class.Tema07p2_LDE_ListaContacto;
...
public class Tema07_LDE_ContactoView extends javax.swing.JFrame {

    private Tema07p2_LDE_ListaContacto listaContactos;

    public Tema07_LDE_ContactoView() {
        initComponents();
        listaContactos = new Tema07p2_LDE_ListaContacto();
        actualizarVista();
    ...
    private void actualizarVista() {
        Tema07p1_LDE_NodoContacto actual = listaContactos.getActual();
    ...
    int posicion = 1;
    Tema07p1_LDE_NodoContacto temp = listaContactos.getActual();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tema07_LDE_ContactoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tema07_LDE_ContactoView().setVisible(true);
            }
        });
    }
