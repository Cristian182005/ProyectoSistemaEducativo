...
import utp.SistemaEducativo.Unid02.Class.Tema06p1_LES_NodoEstudiante;
import javax.swing.table.DefaultTableModel;

public class Tema06p2_LES_ListaEstudiante {
    private Tema06p1_LES_NodoEstudiante cabeza;
    private DefaultTableModel modeloTabla;

    public Tema06p2_LES_ListaEstudiante(DefaultTableModel modeloTabla) {
        this.cabeza = null;
        this.modeloTabla = modeloTabla;
    }

    public void agregarEstudiante(String nombre, String apellido, String curso, double nota) {
    Tema06p1_LES_NodoEstudiante nuevoNodo = new Tema06p1_LES_NodoEstudiante(nombre, apellido, curso, nota);
    ...
    public void ordenarPorNota() {
        ...
        do {
            intercambio = false;
            Tema06p1_LES_NodoEstudiante actual = cabeza;
            Tema06p1_LES_NodoEstudiante anterior = null;
            Tema06p1_LES_NodoEstudiante siguiente = cabeza.getSiguiente();
