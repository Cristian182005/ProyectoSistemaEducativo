...
public class MenuPrincipalView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnUnidad04.setForeground(new java.awt.Color(255, 255, 0));
        btnUnidad04.setText("UNIDAD 04");
        btnUnidad04.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 3, true));
        btnUnidad04.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnUnidad04ActionPerformed(evt);
            }
        });
        jPanel2.add(btnUnidad04, new org.netbeans.lib.awtextra.AbsoluteConstraints(1190, 40, 130, 50));

        btnUnidad01.setBackground(new java.awt.Color(51, 153, 255));
        btnUnidad01.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        btnUnidad01.setForeground(new java.awt.Color(255, 255, 0));
        btnUnidad01.setText("UNIDAD 01");
        btnUnidad01.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 3, true));
        btnUnidad01.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnUnidad01ActionPerformed(evt);
            }
        });
        jPanel2.add(btnUnidad01, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 40, 130, 50));

        btnUnidad02.setBackground(new java.awt.Color(51, 153, 255));
        btnUnidad02.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        btnUnidad02.setForeground(new java.awt.Color(255, 255, 0));
        btnUnidad02.setText("UNIDAD 02");
        btnUnidad02.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 3, true));
        btnUnidad02.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnUnidad02ActionPerformed(evt);
            }
        });
        jPanel2.add(btnUnidad02, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 40, 130, 50));

        btnUnidad03.setBackground(new java.awt.Color(51, 153, 255));
        btnUnidad03.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        btnUnidad03.setForeground(new java.awt.Color(255, 255, 0));
        btnUnidad03.setText("UNIDAD 03");
        btnUnidad03.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 3, true));
        btnUnidad03.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnUnidad03ActionPerformed(evt);
            }
        });
        jPanel2.add(btnUnidad03, new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 40, 130, 50));

        jlTitulo01.setBackground(new java.awt.Color(51, 153, 255));
        jlTitulo01.setFont(new java.awt.Font("Segoe UI Black", 1, 24)); // NOI18N
        jlTitulo01.setForeground(new java.awt.Color(255, 255, 255));
        jlTitulo01.setText("SISTEMA EDUCATIVO");
        jPanel2.add(jlTitulo01, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 20, -1, -1));

        jlTitulo02.setBackground(new java.awt.Color(51, 153, 255));
        jlTitulo02.setFont(new java.awt.Font("Segoe UI Black", 1, 24)); // NOI18N
        jlTitulo02.setForeground(new java.awt.Color(255, 255, 255));
        jlTitulo02.setText("ALGORITMO Y ESTRUCTURA DE DATOS");
        jPanel2.add(jlTitulo02, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 60, -1, -1));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 2000, 120));

        jLabel3.setFont(new java.awt.Font("Segoe UI Black", 1, 22)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Nos alegra tenerte aquí. Este espacio ha sido creado especialmente para");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, -1, -1));

        jPanel4.setBackground(new java.awt.Color(51, 153, 255));
        jPanel4.setMinimumSize(new java.awt.Dimension(1320, 110));
        jPanel4.setPreferredSize(new java.awt.Dimension(1200, 120));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("© 2025 Sistema Educativo | Todos los derechos reservados");

        jLabel14.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setText("Este sitio ha sido desarrollado con fines educativos para brindar apoyo a estudiantes mediante teoría clara y ejercicios resueltos.");

        jLabel15.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(255, 255, 255));
        jLabel15.setText("Contáctanos: sistemaeducativo@gmail.com | Síguenos en redes sociales para más contenido.");
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 600, 1550, 150));

        jLabel4.setFont(new java.awt.Font("Segoe UI Black", 1, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 153, 51));
        jLabel4.setText("Aquí encontrarás:");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 320, 230, 40));

        jLabel5.setFont(new java.awt.Font("Segoe UI Black", 1, 48)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 153, 51));
        jLabel5.setText("¡Bienvenido al Sistema Educativo!");
        ...
        jLabel6.setText("ayudarte a comprender mejor los temas que estudias, combinando teoría clara");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 240, 970, 40));

        jLabel7.setFont(new java.awt.Font("Segoe UI Black", 1, 24)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("- Explicaciones sencillas y directas.");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 400, 450, 40));

        jLabel8.setFont(new java.awt.Font("Segoe UI Black", 1, 22)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("con ejercicios resueltos paso a paso.");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 280, 460, 40));

        jLabel9.setFont(new java.awt.Font("Segoe UI Black", 1, 24)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("¡Comencemos! :D");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 540, 230, 40));

        jLabel10.setFont(new java.awt.Font("Segoe UI Black", 1, 24)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("- Ejemplos prácticos que refuerzan lo aprendido.");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 360, 610, 40));

        jLabel11.setFont(new java.awt.Font("Segoe UI Black", 1, 24)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("- Contenido organizado para que aprendas a tu ritmo.");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 440, 670, 40));
