...
import utp.SistemaEducativo.Unid04.Class.Tema10p2_AGB_ArbolExpresion;
import javax.swing.*;
...
public class Tema10_AGB_ArbolBinarioView extends javax.swing.JFrame {

    private Tema10p2_AGB_ArbolExpresion arbol;

    public Tema10_AGB_ArbolBinarioView() {
        initComponents();
        arbol = new Tema10p2_AGB_ArbolExpresion();
    ...
    private void initComponents() {
        ...
        jPanel8.setMinimumSize(new java.awt.Dimension(1550, 750));
        jPanel8.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel9.setFont(new java.awt.Font("Segoe UI Black", 1, 24)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 51));
        jLabel9.setText("ARBOL DE EXPRESION ARITMETICA");
        jPanel8.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 170, -1, -1));

        jLabel2.setFont(new java.awt.Font("Segoe UI Black", 1, 21)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("EXPRESION:");
        jPanel8.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 250, -1, 40));

        jTextField1.setFont(new java.awt.Font("Segoe UI Black", 1, 21)); // NOI18N
        jTextField1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField1ActionPerformed(evt);
            }
        });
        jPanel8.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 250, 230, -1));
        ...
        jPanel8.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 420, 520, 250));

        jLabel1.setFont(new java.awt.Font("Segoe UI Black", 1, 21)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("SOLUCION:");
        jPanel8.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 340, -1, 40));
        ...
        jPanel8.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 290, 160, 50));

        txtSolucion.setFont(new java.awt.Font("Segoe UI Black", 1, 21)); // NOI18N
        txtSolucion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtSolucionActionPerformed(evt);
            }
        });
        jPanel8.add(txtSolucion, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 340, 230, -1));
        ...
        jPanel8.add(BarraLateral, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 200, 770));

        jLabel10.setFont(new java.awt.Font("Segoe UI Black", 1, 36)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 153, 51));
        jLabel10.setText("Árboles generales y binarios – Definición y recorridos");
        jPanel8.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 80, 1010, -1));
        ...
        jPanel8.add(btnVolver, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 20, 120, 40));

        jLabel35.setIcon(new javax.swing.ImageIcon(getClass().getResource("/utp/SistemaEducativo/Images/java.png"))); // NOI18N
        jPanel8.add(jLabel35, new org.netbeans.lib.awtextra.AbsoluteConstraints(1270, 20, -1, -1));
        ...
        jPanel8.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 0, 1360, 770));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (expresion.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Por favor ingrese una expresión", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            ...
            // Mostrar recorridos
            jTextArea1.setText("PREORDEN (Prefija): " + arbol.preorden() + "\n\n"
                    + "INORDEN (Infija): " + arbol.inorden() + "\n\n"
                    + "POSTORDEN (Postfija): " + arbol.postorden());

            // Calcular y mostrar solución
            double resultado = arbol.evaluar();
            txtSolucion.setText(String.valueOf(resultado));

        } catch (ArithmeticException e) {
            JOptionPane.showMessageDialog(this, "Error matemático: " + e.getMessage(),
                    "Error", JOptionPane.ERROR_MESSAGE);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Expresión inválida: " + e.getMessage(),
                    "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tema10_AGB_ArbolBinarioView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tema10_AGB_ArbolBinarioView().setVisible(true);
            }
        });
    }
