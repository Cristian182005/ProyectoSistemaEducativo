...
import utp.SistemaEducativo.Unid04.Class.Tema11p2_AB_ArbolBinario;
...
public class Tema11_AB_OperacionesBasicasView extends javax.swing.JFrame {

    Tema11p2_AB_ArbolBinario arbol = new Tema11p2_AB_ArbolBinario();

    public Tema11_AB_OperacionesBasicasView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Árboles binarios – Operaciones básicas");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 70, 850, -1));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        arbol.inorden(arbol.raiz, sb);
        txtArea.append(sb.toString() + "\n");
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        arbol.eliminarRaiz();
        txtArea.append("Árbol eliminado.\n");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tema11_AB_OperacionesBasicasView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tema11_AB_OperacionesBasicasView().setVisible(true);
            }
        });
    }
