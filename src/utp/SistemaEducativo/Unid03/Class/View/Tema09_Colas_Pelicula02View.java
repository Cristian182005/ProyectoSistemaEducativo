 ...
 * @author USER
 */
public class Tema09_Colas_Pelicula02View extends javax.swing.JFrame {

    Tema09_Colas_ColaClientexPelicula cola2 = new Tema09_Colas_ColaClientexPelicula();

    /**
     * Creates new form cola2
     */
    public Tema09_Colas_Pelicula02View() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        panelCartelera1 = new javax.swing.JPanel();
        panelCartelera2 = new javax.swing.JPanel();
        panelCartelera3 = new javax.swing.JPanel();
        panelCartelera4 = new javax.swing.JPanel();
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(1570, 750));
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblpelicula.setFont(new java.awt.Font("Segoe UI Black", 1, 24)); // NOI18N
        lblpelicula.setForeground(new java.awt.Color(255, 255, 51));
        lblpelicula.setText("NOMBRE DE LA PELICULA:");
        lblpelicula.setToolTipText("");
        jPanel1.add(lblpelicula, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 150, -1, 40));

        txtNombre.setFont(new java.awt.Font("Segoe UI Black", 1, 24)); // NOI18N
        jPanel1.add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 150, 360, -1));
        ...
        jPanel1.add(btnAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 150, 150, -1));

        btnRetirar.setBackground(new java.awt.Color(51, 153, 255));
        btnRetirar.setFont(new java.awt.Font("Segoe UI Black", 1, 24)); // NOI18N
        btnRetirar.setForeground(new java.awt.Color(255, 255, 51));
        btnRetirar.setText("RETIRAR DE CARTELERA");
        btnRetirar.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(51, 153, 255), 2, true));
        btnRetirar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnRetirarActionPerformed(evt);
            }
        });
        jPanel1.add(btnRetirar, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 230, 330, -1));

        btnPrimera.setBackground(new java.awt.Color(51, 153, 255));
        btnPrimera.setFont(new java.awt.Font("Segoe UI Black", 1, 24)); // NOI18N
        btnPrimera.setForeground(new java.awt.Color(255, 255, 51));
        btnPrimera.setText("PRIMERA EN CARTELERA");
        btnPrimera.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(51, 153, 255), 2, true));
        btnPrimera.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnPrimeraActionPerformed(evt);
            }
        });
        jPanel1.add(btnPrimera, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 230, 330, -1));
        ...
        jPanel1.add(btnVaciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 230, 140, -1));
        ...
        jPanel1.add(btnLlenaVacia, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 290, 230, -1));
        ...
        jPanel1.add(lblContador, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 360, 90, 30));

        lblpelicula1.setFont(new java.awt.Font("Segoe UI Black", 1, 24)); // NOI18N
        lblpelicula1.setForeground(new java.awt.Color(255, 255, 51));
        lblpelicula1.setText("COLA DE PELICULAS:");
        lblpelicula1.setToolTipText("");
        jPanel1.add(lblpelicula1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 350, -1, -1));

        lblpelicula2.setFont(new java.awt.Font("Segoe UI Black", 1, 24)); // NOI18N
        lblpelicula2.setForeground(new java.awt.Color(255, 255, 51));
        lblpelicula2.setText("CARTELERA VISUAL:");
        lblpelicula2.setToolTipText("");
        jPanel1.add(lblpelicula2, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 350, -1, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 390, 370, 200));

        panelCartelera.setBackground(new java.awt.Color(51, 153, 255));
        panelCartelera.setForeground(new java.awt.Color(255, 255, 255));
        panelCartelera.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        jPanel1.add(panelCartelera, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 390, 200, 90));

        panelCartelera1.setBackground(new java.awt.Color(51, 153, 255));
        panelCartelera1.setForeground(new java.awt.Color(255, 255, 51));
        panelCartelera1.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        jPanel1.add(panelCartelera1, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 390, 200, 90));

        panelCartelera2.setBackground(new java.awt.Color(51, 153, 255));
        panelCartelera2.setForeground(new java.awt.Color(255, 255, 51));
        panelCartelera2.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        jPanel1.add(panelCartelera2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1130, 390, 200, 90));

        panelCartelera3.setBackground(new java.awt.Color(51, 153, 255));
        panelCartelera3.setForeground(new java.awt.Color(255, 255, 51));
        panelCartelera3.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        jPanel1.add(panelCartelera3, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 500, 180, 90));

        panelCartelera4.setBackground(new java.awt.Color(51, 153, 255));
        panelCartelera4.setForeground(new java.awt.Color(255, 255, 51));
        panelCartelera4.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        jPanel1.add(panelCartelera4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 500, 180, 90));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 0, 1380, 760));
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        if (!cola2.isColaLlena()) {
            cola2.insertarCola(nombre);
            txtNombre.setText("");
            actualizarTexto();

            // Mover las imágenes existentes
            moverImagenes();

            // Cargar nueva imagen en el panel principal
            cargarImagenEnPanel(nombre, panelCartelera);

            JOptionPane.showMessageDialog(this, "Se agregó: " + nombre);
        } else {
            JOptionPane.showMessageDialog(this, "La cartelera está llena");
        }
    }//GEN-LAST:event_btnAgregarActionPerformed

    private void btnRetirarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRetirarActionPerformed
        if (!cola2.isColaVacia()) {
            String atendido = cola2.primeroCola();
            cola2.eliminarCola();

            // Eliminar solo del último panel (el más antiguo)
            if (panelCartelera4.getComponentCount() > 0) {
                panelCartelera4.remove(0);
            }

            // Mover todas las imágenes un paso hacia adelante
            moverImagenes();

            actualizarTexto();
            JOptionPane.showMessageDialog(this, "Se retiró de la cartelera: " + atendido);
        } else {
            JOptionPane.showMessageDialog(this, "La cartelera está vacía");
        }
    }//GEN-LAST:event_btnRetirarActionPerformed

    private void btnPrimeraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrimeraActionPerformed
        if (!cola2.isColaVacia()) {
            String primero = cola2.primeroCola();
            JOptionPane.showMessageDialog(this, "La película destacada es: " + primero);
        } else {
            JOptionPane.showMessageDialog(this, "La cartelera está vacía");
        }
    ...
    private void btnVaciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVaciarActionPerformed
        // Vaciar la cola de datos
        cola2.vaciarCola();

        // Limpiar todos los paneles visuales
        panelCartelera.removeAll();
        panelCartelera1.removeAll();
        panelCartelera2.removeAll();
        panelCartelera3.removeAll();
        panelCartelera4.removeAll();

        // Actualizar la visualización de todos los paneles
        panelCartelera.revalidate();
        panelCartelera.repaint();
        panelCartelera1.revalidate();
        panelCartelera1.repaint();
        panelCartelera2.revalidate();
        panelCartelera2.repaint();
        panelCartelera3.revalidate();
        panelCartelera3.repaint();
        panelCartelera4.revalidate();
        panelCartelera4.repaint();

        // Actualizar el texto de la cola
        actualizarTexto();

        JOptionPane.showMessageDialog(this, "La cartelera ha sido completamente vaciada");
    ...
    private void btnLlenaVaciaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLlenaVaciaActionPerformed
        boolean vacia = cola2.isColaVacia();
        boolean llena = cola2.isColaLlena();
        String mensaje = "¿La cartelera está vacía? " + (vacia ? "Sí" : "No")
                + "\n¿La cartelera está llena? " + (llena ? "Sí" : "No");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tema09_Colas_Pelicula02View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tema09_Colas_Pelicula02View().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JPanel panelCartelera1;
    private javax.swing.JPanel panelCartelera2;
    private javax.swing.JPanel panelCartelera3;
    private javax.swing.JPanel panelCartelera4;
    ...
    private void actualizarTexto() {
        txaMostrar.setText("Contenido actual:\n" + cola2.mostrarCola());
        lblContador.setText(cola2.cantidadElementos() + "/" + cola2.getMAX());
    }

    private void moverImagenes() {
        // Mover imagen de panel4 a panel5 (último panel)
        if (panelCartelera3.getComponentCount() > 0) {
            Component comp = panelCartelera3.getComponent(0);
            panelCartelera3.remove(comp);
            panelCartelera4.add(comp);
        }

        // Mover imagen de panel3 a panel4
        if (panelCartelera2.getComponentCount() > 0) {
            Component comp = panelCartelera2.getComponent(0);
            panelCartelera2.remove(comp);
            panelCartelera3.add(comp);
        }

        // Mover imagen de panel2 a panel3
        if (panelCartelera1.getComponentCount() > 0) {
            Component comp = panelCartelera1.getComponent(0);
            panelCartelera1.remove(comp);
            panelCartelera2.add(comp);
        }

        // Mover imagen de panel1 a panel2
        if (panelCartelera.getComponentCount() > 0) {
            Component comp = panelCartelera.getComponent(0);
            panelCartelera.remove(comp);
            panelCartelera1.add(comp);
        }
    ...
    private void cargarImagenEnPanel(String nombre, JPanel panel) {
        panel.removeAll();

        String archivoImagen = nombre.toLowerCase().replace(" ", "_") + ".jpg";
        String ruta = "src/main/resources/imagen/" + archivoImagen;

        try {
            BufferedImage imagen = ImageIO.read(new File(ruta));
            Image imgEscalada = imagen.getScaledInstance(100, 150, Image.SCALE_SMOOTH);
            ImageIcon icono = new ImageIcon(imgEscalada);

            JLabel lblPoster = new JLabel(nombre, icono, JLabel.CENTER);
            lblPoster.setVerticalTextPosition(JLabel.BOTTOM);
            lblPoster.setHorizontalTextPosition(JLabel.CENTER);

            panel.add(lblPoster);
        } catch (Exception ex) {
            JLabel lblPoster = new JLabel(nombre);
            panel.add(lblPoster);
        }
